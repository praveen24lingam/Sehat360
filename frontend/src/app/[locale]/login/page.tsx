...
import { ChevronLeft, AlertCircle, Mail, Lock, Sparkles, ArrowRight } from 'lucide-react'
    ...
    <div className="bg-brand-smoke min-h-[100dvh] w-full flex flex-col items-center justify-center p-4 relative overflow-hidden select-none">
      ...
      >
        <div className="text-center mt-2 mb-8">
          ...
          <h1 className="text-2xl md:text-3xl font-black text-brand-ink mb-2 tracking-tight">{t('login.title') || 'Login'}</h1>
          <p className="text-sm text-brand-inkSoft font-medium">
            {t('login.subtitle') || 'Welcome back to SehatMitra'}
          </p>
        </div>
